...
func GetOrCreateCurrencyRate(base, date string, rates map[string]float64) (*encurrency.Rate, error) {
	log := logrus.WithFields(logrus.Fields{"module": "services/currency/rate", "method": "GetOrCreateCurrencyRate", "base": base, "date": date, "rates": rates})
